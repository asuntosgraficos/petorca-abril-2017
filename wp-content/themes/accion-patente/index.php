...
<p><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span> <?php echo $project->place; ?></p>
<hr />
...
<p><?php the_title();?> exige una inversión total de <?php echo '<span>$</span> '.number_format($project->budget_gen, 0, ',', '.'); ?>. <?php echo html_entity_decode ($project->budget_desc); ?></p>
<hr />
