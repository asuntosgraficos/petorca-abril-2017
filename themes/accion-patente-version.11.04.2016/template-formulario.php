...
<div class="row">
  ...
  <div class="alert alert-recuadro">
    ...
    <div class="form-group row">
    <div class="col-sm-6">
      <label for="projectActualImage" class="imagen">Imagen de referencia: Estado Actual</label>
    </div>
    <div class="col-sm-6">
...
<p class="indicacion">Se recomienda indicar, al menos, 3 ítem que al sumarse den por resultado el valor general. En cada ítem debe ingresar un nombre, valor parcial y justificación breve.</p>
...
<p class="indicacion">Se recomienda indicar, al menos, 3 etapas de ejecución. En cada etapa debe ingresar un nombre, fecha de inicio, fecha de término y descripción breve de los objetivos que deben cumplirse en la respectiva etapa.</p>
  ...
  <!--EL COSO COSO-->
    ...
    <!--eso lo controlaría-->
      ...
      <h5>Funcionario Municipal responsable</h5>
...
<div class="alert alert-recuadro">
      ...
      <h5>Responsable de la ejecución (construye)</h5>
...
<div class="alert alert-recuadro">
      ...
      <h5>Profesional Responsable del Proyecto</h5>
...
<div class="alert alert-recuadro">
      ...
      <div class="col-xs-10 col-md-11 final">
        ...
        ?>
        <button class="btn btn-warning btn-lg" id="to_check">REVISAR</button>
